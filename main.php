...
<html>
  <head>
    ...
    <!-- favicon -->
    <link rel="" href="assets/img/favicon.png" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:20px">Webicamentos</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="" target="_blank">Ghosto Web</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
